# caster-combat-profile Specification

## Purpose

Defines the `caster` combat profile and archetype: a `support`-derived combat
profile with two intentional deltas, applied to the Apprentice unit line, and
the AI-scoring and archetype-scoping behaviour that follows from it.
