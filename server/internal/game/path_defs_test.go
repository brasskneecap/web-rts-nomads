...
func TestPathCatalog_ShippedPathsHaveAllRanks(t *testing.T) {
	paths := []string{unitPathVanguard, unitPathBerserker, unitPathTrapper, unitPathMarksman}
...
func TestPathCatalog_BaseRankAlwaysIdentity(t *testing.T) {
	paths := []string{unitPathNone, unitPathVanguard, unitPathBerserker, unitPathTrapper, unitPathMarksman}
