...
func TestProfileUpgrade_PhysicalPowerRank3_Multiplier(t *testing.T) {
	s := NewGameStateWithSeed(GetMapConfigByID(DefaultMapID()), 1)
	s.EnsurePlayerWithUpgrades("p1", map[string]int{"physical_power": 3}, nil)
...
func TestProfileUpgrade_AdditionalWorkerRank2_ExtraWorkers(t *testing.T) {
	...
	s.EnsurePlayerWithUpgrades("p2", map[string]int{"additional_worker": 2}, nil)
...
func TestProfileUpgrade_MagicPowerRank1_OnlyMagicMultiplied(t *testing.T) {
	s := NewGameStateWithSeed(GetMapConfigByID(DefaultMapID()), 1)
	s.EnsurePlayerWithUpgrades("p1", map[string]int{"magic_power": 1}, nil)
...
func TestActiveUpgradeGate_InactiveUpgradeNotApplied(t *testing.T) {
	...
	s.EnsurePlayerWithUpgrades("p1", map[string]int{"physical_power": 3}, []string{})
...
func TestActiveUpgradeGate_ActiveUpgradeApplied(t *testing.T) {
	s := NewGameStateWithSeed(GetMapConfigByID(DefaultMapID()), 1)
	s.EnsurePlayerWithUpgrades("p1", map[string]int{"physical_power": 3}, []string{"physical_power"})
